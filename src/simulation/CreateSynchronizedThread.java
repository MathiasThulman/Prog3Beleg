...
public class CreateSynchronizedThread extends Thread{
    ...
    private DeleteSynchronizedThread deleteThread;
    ...
    public void run(){
        while(true){
            try {
                ...
                this.deleteThread.notify();//TODO what does this do?
            }
        }
    }
    ...
    public void setDeleteThread(DeleteSynchronizedThread deleteThread) {
